...
function RadioGroup({ name, options, className, legend }: RadioGroupProps) {
  return (
    <fieldset className={cn("space-y-3", className)} role="radiogroup" aria-labelledby={legend ? `${name}-legend` : undefined}>
      {legend && (
